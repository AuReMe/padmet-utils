...
Description:
biomass reaction must be at OBJECTIVE_COEFFICIENT=1
For each compound in the reactants of the biomass,
the biomass reaction is recreated with
this compound only as a reactant with stoichio = -1
and the FBA calculated accordingly

usage:
    fba_biomass_reactants.py --network=FILE
